...
are intentionally cleared; choose the DGX Spark Native kernel on Spark or an
equivalent local Python kernel with Torch installed. Mac execution is unverified.
No downloads or GPU are needed for these fixtures. Tests and execution evidence
